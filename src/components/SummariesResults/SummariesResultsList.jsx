...
import SummariesResultItem from './SummariesResultItem';

function SummariesResultsList() {
   const [summariesResults, setSummariesResults] = useState([]);
  ...
  return (
      summariesResults.map((summaryResult) => {
        return <SummariesResultItem key = {summaryResult.bookSummaryID} summaryResult={summaryResult}/>        
      }) 

  )
}

export default SummariesResultsList